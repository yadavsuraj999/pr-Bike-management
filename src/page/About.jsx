            ...
            <div className="py-8 px-4 mx-auto container sm:py-16 lg:px-6">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {features.map(({ title, description, icon }, index) => (
                        <div key={index} className="p-6 border-2 bg-slate-900 rounded-md">
                            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-primary-100 dark:bg-primary-900 border">
                                <svg className="w-6 h-6 text-primary-600 dark:text-primary-300" fill="teal" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    {icon}
                                </svg>
                            </div>
